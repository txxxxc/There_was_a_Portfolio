...
export type ProfileQuery = { profile?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
...
export type ProductsQuery = { allMarkdownRemark: { edges: Array<{ node: (
        ...
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'path' | 'description' | 'thumbnail' | 'date'>> }
      ) }> } };
...
export type TemplateQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path' | 'title' | 'description' | 'date' | 'thumbnail'>> }
  )> };
